...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Runtime_CompilerServices_AsyncVoidMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("Start", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
            ...
            args = new Type[]{typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>.Awaiter), typeof(ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>.Awaiter).MakeByRefType(), typeof(ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter @stateMachine = (ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter)typeof(ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            ((System.Runtime.CompilerServices.AsyncVoidMethodBuilder)instance_of_this_method).Start<ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter>(ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter[];
        ...
        static StackObject* AwaitUnsafeOnCompleted_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>.Awaiter, ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter>(ref @awaiter, ref @stateMachine);
