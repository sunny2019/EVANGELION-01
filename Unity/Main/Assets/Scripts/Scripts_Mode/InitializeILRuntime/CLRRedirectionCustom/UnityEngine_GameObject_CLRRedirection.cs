namespace ILRuntime.Moudle.CLRRedirection
{
    ...
    public static class UnityEngine_GameObject_CLRRedirection
    {
        ...
        public static ILRuntime.Moudle.CrossBindingAdaptorCustom.MonoBehaviourAdapter.Adaptor GetHotFixComponent(this GameObject go, ILType type)
        {
            var arr = go.GetComponents<ILRuntime.Moudle.CrossBindingAdaptorCustom.MonoBehaviourAdapter.Adaptor>();
        ...
        unsafe static StackObject* AddComponent(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (genericArgument != null && genericArgument.Length == 1)
            {
                ...
                else
                {
                    ...
                    //接下来创建Adapter实例
                    var clrInstance = instance.AddComponent<ILRuntime.Moudle.CrossBindingAdaptorCustom.MonoBehaviourAdapter.Adaptor>();
        ...
        unsafe static StackObject* GetComponent(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (genericArgument != null && genericArgument.Length == 1)
            {
                ...
                else
                {
                    ...
                    var clrInstances = instance.GetComponents<ILRuntime.Moudle.CrossBindingAdaptorCustom.MonoBehaviourAdapter.Adaptor>();
