...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Runtime_CompilerServices_AsyncVoidMethodBuilder_Binding
    {
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter @stateMachine = (ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter)typeof(ILRuntime.Moudle.CrossbindAdapter.IAsyncStateMachineAdapter.Adapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
