...
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_ILRuntime_Moudle_CrossBindingAdaptorCustom_ProtoIMessageAdapt_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.Protobuf.Collections.RepeatedField<ILRuntime.Moudle.CrossBindingAdaptorCustom.ProtoIMessageAdapt.Adaptor>);
            args = new Type[]{typeof(Google.Protobuf.CodedOutputStream), typeof(Google.Protobuf.FieldCodec<ILRuntime.Moudle.CrossBindingAdaptorCustom.ProtoIMessageAdapt.Adaptor>)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_0);
            args = new Type[]{typeof(Google.Protobuf.FieldCodec<ILRuntime.Moudle.CrossBindingAdaptorCustom.ProtoIMessageAdapt.Adaptor>)};
            method = type.GetMethod("CalculateSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CalculateSize_1);
            args = new Type[]{typeof(Google.Protobuf.CodedInputStream), typeof(Google.Protobuf.FieldCodec<ILRuntime.Moudle.CrossBindingAdaptorCustom.ProtoIMessageAdapt.Adaptor>)};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.Protobuf.Collections.RepeatedField<ILRuntime.Moudle.CrossBindingAdaptorCustom.ProtoIMessageAdapt.Adaptor>();
